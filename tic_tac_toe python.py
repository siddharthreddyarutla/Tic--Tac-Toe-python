...
# Giving empty strings as input to test_board as an parameter to the function
...
def player_input():
  ...
  wrong=' '
  while wrong!='X' and wrong!='O':
    result=input('player 1,u want to be (x or o):').upper()
    if result=='X':
      return ('X','O')
    else:
      return ('O','X')
...
#Using while loops and the function run the game!
